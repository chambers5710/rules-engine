...
import { applyDamage, moveZoneToSlot, moveZoneToZone } from "../ops.js"
...
function board(): GameState {
  const alakazam = printed("base1-1")
  const blastoise = printed("base1-2")
  const psychic = printed("base1-101")
  const water = printed("base1-102")
