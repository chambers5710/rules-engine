...
const names = ["search", "maintenance", "oak", "impostor", "lass", "trader"] as const
...
function stage(p1: string[], energy: string, p2extra: string[] = []): GameState {
...
function board(name: Name): GameState {
  ...
  let gamestate = stage(["base1-5", "base1-77", "base1-35", "base1-31"], "base1-97")
...
console.log("pnpm serve:deck -- lass   (or search | maintenance | oak | impostor | trader)")
